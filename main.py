...
class Cube(object):
    ...
    def draw(self, surface, eyes=False):
        ...
        pygame.draw.rect(surface, self.colour, (x*dist+1, y*dist+1, dist-2, dist-2))
        if eyes:
            centre = dist // 2
            radius = 3
            circle_middle = (x*dist+centre-radius, y*dist+8)
            circle_middle_2 = (x*dist+dist-radius*2, y*dist+8)
